    ...
    do
    {
        ...
        if (strcmp(password, "505") == 0)
        {
            ...
            do
            {
                ...
                {
                    cout << "My name is Nova and I am a virtual assistant !!!" << endl;
                    string phrase = "My name is Nova and I am a virtual assistant";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if (strcmp(ch, "what is your name") == 0 || strcmp(ch, "name") == 0)
                {
                    cout << "My name is Nova and I am a virtual assistant" << endl;
                    string phrase = "My name is Nova and I am a virtual assistant";
                    string command = "espeak \"" + phrase + "\"";
                ...
                {
                    cout << "openining vs Brave Browser....." << endl;
                    string phrase = "opening Brave Browser";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\Program Files\\BraveSoftware\\Brave-Browser\\Application\\brave.exe"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
                ...
                else if (strcmp(ch, "open vs code") == 0)
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("C:\\Users\\harsh\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
